...
# Bool los valores de True y False}
# Los tipos numericos, es false par el 0 (cero), true para los demas valores
valor = 0.0
...
valor = (5,)
resultado = bool(valor)
print(f'valor de uan tupla con elementos: {valor}, Resultado: {resultado}')
